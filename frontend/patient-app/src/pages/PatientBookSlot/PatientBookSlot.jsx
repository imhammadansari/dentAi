...
const BookSlot = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Fetch all slots for this dentist
            ...
            {loading ? (
                ...
                <div className="space-y-6">
                    {upcomingGroups.map(([dateLabel, dateSlots]) => {
                        const isToday = new Date(dateSlots[0].date).toISOString().split('T')[0] === today;
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        {isFull && (
                                                            <p className="text-xs text-red-400 font-medium mt-0.5">Fully Booked</p>
                                                        )}
                                                    </div>
                                                </div>
