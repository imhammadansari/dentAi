...
const AuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        // Attach refresh token header on every request so the server can
        // silently regenerate an expired access token for all roles.
        ...
        // If server issued a new access token, save it automatically.
    ...
    const verifyUser = async () => {
        ...
        try {
            ...
            // Only clear if there's truly no token — don't kick user out on network blip
