                    ...
                    {dropdownOpen && (
                        <div className="absolute right-0 top-12 w-44 bg-white border border-emerald-100 rounded-xl shadow-lg z-50 overflow-hidden">
                            <button
                                ...
                                className="w-full flex items-center gap-2 px-4 py-3 text-emerald-800 cursor-pointer hover:bg-emerald-50 transition-colors text-sm font-medium"
                            >
                            ...
                            <button
                                ...
                                className="w-full flex items-center gap-2 px-4 py-3 text-red-600 hover:bg-red-50 transition-colors text-sm font-medium cursor-pointer"
                            >
