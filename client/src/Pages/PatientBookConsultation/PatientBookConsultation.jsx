...
const PatientBookConsultation = () => {
  const dentists = [
    { name: 'Dr. Sarah Johnson', specialty: 'Orthodontist', rating: '4.9', next: 'Today, 3:30 PM' },
    { name: 'Dr. Michael Chen', specialty: 'Endodontist', rating: '4.8', next: 'Tomorrow, 10:00 AM' },
    { name: 'Dr. Emily Wilson', specialty: 'Periodontist', rating: '4.9', next: 'Tomorrow, 2:15 PM' },
    { name: 'Dr. James Miller', specialty: 'Oral Surgeon', rating: '4.7', next: 'Feb 22, 11:30 AM' },
  ];
