...
const AdminAllPatients = () => {
    ...
    const statCards = [
        ...
        { icon: CalendarDaysIcon, label: 'Appointments (Booked+Completed)', value: stats.totalAppointments, color: 'from-emerald-500 to-emerald-400' },
        { icon: ClockIcon, label: 'Upcoming (Booked)', value: stats.upcomingCount, color: 'from-amber-400 to-orange-400' },
